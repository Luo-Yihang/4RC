...
from arc.croco.models.dpt_block import DPTOutputAdapter
from arc.croco.models.blocks import Mlp

import arc.dust3r.utils.path_to_croco  # noqa: F401
from arc.dust3r.heads.postprocess import postprocess
...
class Cat_MLP_LocalFeatures_DPT_Pts3d(PixelwiseTaskWithDPT):
    ...
    def __init__(
        ...
        self.two_confs = desc_head_args['two_confs']  # independent confs for 3D regr and descs
    ...
    def forward(self, decout, img_shape):
        ...
        local_features = self.features_head(cat_output)  # B,S,D
